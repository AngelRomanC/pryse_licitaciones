...
import { mdiPlaylistEdit, mdiHomeCity, mdiFormatListChecks, mdiMapMarker,mdiPhone ,mdiEmail} from "@mdi/js"; //agregado
...
<template>
    <LayoutMain :title="titulo">
        <SectionTitleLineWithButton :icon="mdiPlaylistEdit" :title="titulo" main>
