...
import { mdiBallotOutline, mdiFileDocumentCheckOutline, mdiFileDocumentPlus, mdiMapMarker,mdiPhone ,mdiEmail} from "@mdi/js"; //agregado
...
<template>
    <LayoutMain :title="titulo">
        <SectionTitleLineWithButton :icon="mdiFileDocumentPlus" :title="titulo" main>
