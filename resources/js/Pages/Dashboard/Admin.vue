...
import { mdiInformation, mdiFileDocumentOutline, mdiArrowRight } from "@mdi/js";
  ...
  <LayoutDashboard>
              ...
              <tr v-for="documento in documentos.data" :key="documento.id"
                ...
                <div class="flex items-center gap-2">
                  ...
                  <DocumentDetailsModal :documento="documento" :tipo-documento="'documento'" />
                        ...
                        catalog-route-name="documento-legal" return-route="dashboard" :return-id="documento.id"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <CardBox>
        ...
        <PaginationDashboard :currentPage="documentos.current_page" :links="documentos.links"
          :total="documentos.last_page" pageParam="page_tecnico_vencidos" />
      </CardBox>
      ...
      <CardBox>
        ...
        <PaginationDashboard :currentPage="documentosLegal.current_page" :links="documentosLegal.links"
          :total="documentosLegal.last_page" pageParam="page_legal_vencidos" />
      </CardBox>
