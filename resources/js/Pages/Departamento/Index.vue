...
import { mdiTagEdit, mdiDeleteOutline,mdiInformation, mdiPlus, mdiOfficeBuilding } from "@mdi/js";
...
<template>
    <LayoutMain>
        <SectionTitleLineWithButton :title="props.titulo" main :icon="mdiOfficeBuilding" >
