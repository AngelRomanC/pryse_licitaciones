...
import { mdiTagEdit, mdiDeleteOutline ,mdiInformation, mdiPlus, mdiBriefcase} from "@mdi/js";
...
<template>
    <LayoutMain>
        <SectionTitleLineWithButton :title="props.titulo" main :icon="mdiBriefcase">
            <BaseButton :href="route('empresa.create')" color="warning" label="Crear" :icon="mdiPlus"/>
